...
In this chapter, we take a look at R functions in the base packages
that can summarize values. We will use some additional packages for
specialized functions.

```{r 05libraries, error=FALSE}
if(!require(vioplot)){
...
For the visualizations we use the ChickWeight data set that comes with
R.
...
```{r 05chickweight-scatterAll-nicer}
...
```{r 05chickweight-barplot-nicer2}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
...
```{r 05chickweight-boxplot-nicerN}
...
```{r 05chickweight-boxplot-withPoints}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
boxplot(ChickWeight$weight ~ ChickWeight$Time,
...
```{r 05chickweight-boxplot-withJitter}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
boxplot(ChickWeight$weight ~ ChickWeight$Time,
...
```{r 05chickweight-boxplot-withSwarms}
...
```{r 05chickweight-boxplot-withSwarmsColours}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0))#move axis labels
boxplot(ChickWeight$weight ~ ChickWeight$Time,
...
```{r 05chickweight-boxplot-withSwarmsColoursAndLines}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0))#move axis labels
boxplot(ChickWeight$weight ~ ChickWeight$Time,
...
```{r 05chickweight-boxplot-twoFactors}
...
```{r 05chickweight-boxplot-twoFactors-width}
par(mar=c(5,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0))#move axis labels
...
```{r 05boxplotFunctions, include=FALSE}
...
```{r 05chickweight-subset-histogram}
...
```{r 05chickweight-subset-histogram-nicer}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
hist(ChickWeight_3$weight,
...
```{r 05chickweight-subset-boxplot-nicer}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
...
```{r 05chickweight-subset-histogram-withMedian}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
hist(ChickWeight_3$weight,
...
```{r 05chickweight-subset-density}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
...
```{r 05chickweight-subset-density-less}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
...
```{r 05chickweight-subset-vioplot}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
...
```{r 05chickweight-subset-vioplot-complete}
par(mar=c(3,3,0.5,0.5), #different margins
    tcl=-0.3, #shorter tick marks
    mgp=c(1.9,0.5,0)) #move axis labels
vioplot(ChickWeight_3$weight,
...
```{r 05chickweight-subset-vioplot-diets}
